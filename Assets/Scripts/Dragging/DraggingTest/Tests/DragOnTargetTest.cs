...
{
    public TargetingOptions Targets = TargetingOptions.AllFieldCards;
    ...
    public override void OnDraggingInUpdate()
    {
        ...
        {
            //kelton note here, had to change this to work with old unity
            //draw a line between the creature and the target
            lr.SetPosition(0, transform.parent.position);
            lr.SetPosition(1, transform.position - direction * 2.3f);
